...
static const char *ssocrengcmd[]     = { "screenshot_ocr.sh", "eng+chi_sim", NULL };
...
static Key keys[] = {
        ...
        { WINKEY,                        XK_w,            spawn,          {.v = ssocrengcmd } },
        { WINKEY|ShiftMask,              XK_w,            spawn,          {.v = ssocrchicmd } },
        { WINKEY|ControlMask,            XK_w,            spawn,          {.v = xclipcopycmd } },
