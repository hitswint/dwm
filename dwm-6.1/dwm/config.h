...
static const char *rofimountcmd[]     = { "rofi-mount.sh", NULL };
static const char *rofiumountcmd[]    = { "rofi-umount.sh", NULL };
static const char *rofivirtualboxcmd[]= { "rofi-virtualbox.sh", NULL };
static const char *rofiopencmd[]      = { "rofi-open.sh", NULL };
static const char *rofiopenothercmd[] = { "rofi-open.sh", "other", NULL };
static const char *keynavcmd[]        = { "keynav.sh", NULL };
static const char *thunarcmd[]        = { "thunar", NULL };
static const char *thunarcdcmd[]      = { "openincd.sh", "thunar", NULL };
static const char *fsearchcmd[]       = { "fsearch", NULL };
static const char *termcmd[]          = { "urxvt", NULL };
static const char *termcdcmd[]        = { "openincd.sh", "urxvt -cd", NULL };
...
static const char *powercmd[]         = { "power.sh", "ROFI", NULL };
