...
static Key keys[] = {
        ...
        { WINKEY,                        XK_F10,          spawn,          {.v = pactlvoldowncmd } },
        { WINKEY,                        XK_F11,          spawn,          {.v = pactlvolupcmd } },
        { WINKEY,                        XK_F9,           spawn,          {.v = pactlmutecmd } },
        /* Set layout. */
        ...
        /* MPD setup. */
        { WINKEY,                        XK_F5,           spawn,          {.v = mpdseekminuscmd } },
        { WINKEY,                        XK_F6,           spawn,          {.v = mpdseekpluscmd } },
        { WINKEY,                        XK_F7,           spawn,          {.v = mpdtogglecmd } },
        { WINKEY,                        XK_F8,           spawn,          {.v = mpdstopcmd } },
        { WINKEY|ShiftMask,              XK_F5,           spawn,          {.v = mpdprevcmd } },
        { WINKEY|ShiftMask,              XK_F6,           spawn,          {.v = mpdnextcmd } },
        { WINKEY|ControlMask,            XK_F5,           spawn,          {.v = mpdvoldowncmd } },
        { WINKEY|ControlMask,            XK_F6,           spawn,          {.v = mpdvolupcmd } },
        /* Mouse */
