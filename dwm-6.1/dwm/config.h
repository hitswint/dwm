...
static const char *roficlipcmd[]     = { "rofi-clip", NULL };
...
static Key keys[] = {
        ...
        { WINKEY|ControlMask,            XK_bracketleft,  incnmaster,     {.i = -1 } },
        { WINKEY|ControlMask,            XK_bracketright, incnmaster,     {.i = +1 } },
        { WINKEY|ControlMask,            XK_backslash,    setnmaster,     {.i = 0} },
