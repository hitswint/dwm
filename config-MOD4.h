...
#define TILEKEYS(MOD,G,M,S)                                             \
  ...
  { MOD, XK_u, setdirs,  {.v = (int[])  { INC(G * +1),   INC(M * +1),   INC(S * +1) } } }, \
...
static const char *zoomtoemacscmd[]  = { "run-or-raise.sh", "emacs", "emacs", NULL };
...
static Key keys[] = {
        ...
        { MODKEY4|ControlMask,           XK_i,            incnmaster,       {.i = +1 } },
        { MODKEY4|ControlMask,           XK_o,            incnmaster,       {.i = -1 } },
        ...
        /* { MODKEY4,                       XK_e,            runorraise,       {.v = emacscmd } }, */
        /* { MODKEY4,                       XK_s,            spawn,            {.v = switchcmd } }, */
        /* View. */
        { MODKEY4|ShiftMask,             XK_q,            quit,             {0} },
        { MODKEY4,                       XK_grave,        view,             {0} },
        { MODKEY4,                       XK_Escape,       view,             {0} },
        { MODKEY4,                       XK_o,            zoom,             {0} },
        { MODKEY4|ShiftMask,             XK_o,            spawn,            {.v = zoomtoemacscmd } },
        /* { MODKEY1,                       XK_F4,           killclient,       {0} }, */
        { MODKEY4,                       XK_q,            killclient,       {0} },
        { MODKEY4,                       XK_7,            view,             {.ui = ~0 } },
        { MODKEY4|ShiftMask,             XK_7,            tag,              {.ui = ~0 } },
        /* Focus adjacent tag. */
        { MODKEY4|ControlMask,           XK_k,            viewtoleft,       {0} },
        { MODKEY4|ControlMask,           XK_j,            viewtoright,      {0} },
        { MODKEY4|ControlMask|ShiftMask, XK_k,            tagtoleft,        {0} },
        { MODKEY4|ControlMask|ShiftMask, XK_j,            tagtoright,       {0} },
        /* Multi monitors. */
        ...
        /* Exresize. */
        { MODKEY4,                       XK_minus,        exresize,         {.v = (int []){ -50,   0 }}},
        { MODKEY4,                       XK_equal,        exresize,         {.v = (int []){  50,   0 }}},
        { MODKEY4|ShiftMask,             XK_minus,        exresize,         {.v = (int []){   0, -50 }}},
        { MODKEY4|ShiftMask,             XK_equal,        exresize,         {.v = (int []){   0,  50 }}},
