...
static Key keys[] = {
  ...
  /* exresize */
  /* 这里面的maximize功能不好 */
  /* { MOD4|ShiftMask,               XK_Up,     explace,                {.ui = EX_N  }}, */
  /* { MOD4|ShiftMask,               XK_Left,   explace,                {.ui = EX_W  }}, */
  /* { MOD4|ShiftMask,               XK_Right,  explace,                {.ui = EX_E  }}, */
  /* { MOD4|ShiftMask,               XK_Down,   explace,                {.ui = EX_S  }}, */
  { MOD4,                         XK_bracketleft,    explace,                {.ui = EX_NW }},
  { MOD4,                         XK_bracketright,   explace,                {.ui = EX_NE }},
  { MOD4|ControlMask,             XK_bracketleft,    explace,                {.ui = EX_SW }},
  { MOD4|ControlMask,             XK_bracketright,   explace,                {.ui = EX_SE }},
  /* { MODKEY|MOD4,                       XK_5,   explace,                {.ui = EX_C  }}, */
  { MOD4,                         XK_equal,          exresize,               {.v = (int []){   0,  50 }}},
  { MOD4,                         XK_minus,          exresize,               {.v = (int []){   0, -50 }}},
  { MOD4|ControlMask,             XK_equal,          exresize,               {.v = (int []){  50,   0 }}},
  { MOD4|ControlMask,             XK_minus,          exresize,               {.v = (int []){ -50,   0 }}},
