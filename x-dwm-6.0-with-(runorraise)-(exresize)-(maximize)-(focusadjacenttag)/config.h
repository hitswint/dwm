...
static Key keys[] = {
  ...
  { MOD4,                         XK_a,      viewtoleft,     {0} },
  { MOD4,                         XK_d,      viewtoright,    {0} },
  { MOD4|ShiftMask,               XK_a,      tagtoleft,      {0} },
  { MOD4|ShiftMask,               XK_d,      tagtoright,     {0} },
  { MOD4,                         XK_w,      focusmon,       {.i = -1 } },
  { MOD4,                         XK_s,      focusmon,       {.i = +1 } },
  { MOD4|ShiftMask,               XK_w,      tagmon,         {.i = -1 } },
  { MOD4|ShiftMask,               XK_s,      tagmon,         {.i = +1 } },
  TAGKEYS(                        XK_8,                      0)
  TAGKEYS(                        XK_9,                      1)
  TAGKEYS(                        XK_0,                      2)
  /* MPD setup */
